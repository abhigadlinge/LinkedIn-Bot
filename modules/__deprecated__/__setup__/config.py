...
search_terms = ["Software Engineer", "Software Developer", "Angular Developer", "Dotnet Developer", "SQL Developer", "React Developer", "Java Developer", "Front End Developer", "Full Stack Developer", "Web Developer", "Nodejs Developer", "React Native Developer", "Associate Software Developer", "Full Stack Developer (Angular + .NET)", "Full Stack Developer (Java & Angular)", "React.js Developer", "React JS Developer", "Java Developer (Remote)", "Full Stack Developer (MERN Stack)", "Backend Developer", "Frontend Developer", "Junior Software Developer", "Entry Level Software Developer", "Graduate Software Engineer", "Backend Engineer", "Frontend Engineer"]
...
phone_number = "7058784019"        # Enter your 10 digit number in quotes Eg: "9876543210"
...
website = "https://github.com/abhigadlinge"                       # "www.example.bio" or "" and so on....

# What to enter in your desired salary question, only enter in numbers inside quotes as some companies only allow numbers
desired_salary = "600000"          # "80000", "90000", "100000" or "120000" and so on....

# Example question: "On a scale of 1-10 how much experience do you have building web or mobile applications? 1 being very little or only in school, 10 being that you have built and launched applications to real users"
confidence_level = "8"             # Any number between "1" to "10" including 1 and 10, put it in quotes ""

current_city = "Thane"                  # If left empty will fill in location of jobs location.

## SOME ANNOYING QUESTIONS BY COMPANIES 🫠 ##
# Address, not so common question but some job applications make it required!
street = "Sector 4, Near Janta Market, Airoli"
state = "Maharashtra"
zipcode = "400708"
country = "India"

first_name = "Abhijeet"                 # Your first name in quotes Eg: "First", "Sai"
middle_name = "Rambhau"            # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Gadlinge"                # Your last name in quotes Eg: "Last", "Golla"

# Your LinkedIn headline in quotes Eg: "Software Engineer @ Google, Masters in Computer Science", "Recent Grad Student @ MIT, Computer Science"
headline = "Full Stack Developer with Bachelor in Computer Science and 1+ years of experience"

# Your summary in quotes, use \n to add line breaks
summary = """
I'm a Full Stack Developer with hands-on experience in building scalable and performance-optimized web applications using Angular, React, .NET, Node.js, and MongoDB. With a strong foundation in Data Structures, System Design, and Clean Code Principles, I thrive in fast-paced environments and love solving real-world problems through code.

At Circular Angle, I improved web performance by 35%, optimized backend queries by 40%, and built scalable REST APIs that enhanced system efficiency by 50%. I’ve worked with both frontend and backend tech, giving me a holistic understanding of application flow.

Previously at AiSense LLP, I designed 15+ reusable UI components using React + Tailwind CSS and boosted dev speed by 30%. I've also completed structured internship training on DSA and CS fundamentals via Persistent Systems.

Looking for full-time software development roles (Remote/Hybrid/On-site) where I can contribute with both frontend and backend capabilities. I'm passionate about learning, collaborating, and building systems that make a real impact.
"""
...
bad_words = ["US Citizen","USA Citizen","No C2C", "No Corp2Corp", "Embedded Programming", "PHP", "Ruby"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
...
chatGPT_username = "abhigadlinge@gmail.com"
chatGPT_password = "Pass@6503"
