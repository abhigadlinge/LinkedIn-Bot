...
# connect_request_message = "Hi, I admire the work your company is doing. I'm actively looking for software roles and would really value the chance to connect with you." # Leave Empty to send connection request without personalized invitation (recommended to leave it empty, since you only get 10 per month without LinkedIn Premium*)
connect_request_message = ""
